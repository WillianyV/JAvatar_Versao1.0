...
public class GerarPerguntas {
    ...
    //14
    quiz.add(new Perguntas("Dadas as seguintes classes, todas no mesmo pacote. Qual o resultado da impressão ao executamos a classe Homem?",
            "Primata andando Mamífero ouvindo Homem vendo", 
            "Arquivos/Imagens/Perguntas/14.png", 
            new String[] {
                "Mamífero andando Mamífero ouvindo Mamífero vendo",
                "Primata andando Mamífero ouvindo Homem vendo",
                "Uma exception será lançada: MethodNotFoundException",
                "Mamífero andando Mamífero ouvindo Homem vendo"}));
    //15
    ...
    //17
    quiz.add(new Perguntas("Em aplicações em que se utilizam os conceitos de orientação a objetos, precisa-se constantemente manipular muitas informações e muitos objetos ao mesmo tempo. "
            + "Então, utilizam-se estruturas que permitem armazená-los e recuperá-los sempre que se desejar. A linguagem Java oferece várias dessas estruturas de dados em um conjunto de "
            + "classes chamadas de coleções. Nesse contexto, uma API da linguagem Java que tem como característica implementar coleções ordenadas (sequências) é", 
            "java.util.List<E>", 
            null, new String[] {
                "java.util.HashSet<E>",
                "java.util.List<E>",
