...
public class Personagem {
    ...
    public void inicializarSprite() {
        if (orientacao.equals(Util.ESQUERDA)) {
            if (nomePersonagem.equals(Util.AANG)) {
                try {
                    personagem = new Sprite("Arquivos\\Imagens\\Telas\\AangLuta.png", 10, 172, 112, 8, 4, 400, 570);
                    ataqueSprite = new Sprite("Arquivos\\Imagens\\Telas\\ataques.png", 0, 32, 32, 6, 2, 535, 600);
                } catch (IOException e) {
                    Mensagens.messagemErro("Erro ao exibir as Sprites de Aang.\n" + e);
                }
            } else if (nomePersonagem.equals(Util.KATARA)) {
                try {
                    personagem = new Sprite("Arquivos\\Imagens\\Telas\\KataraLuta.png", 10, 135, 122, 8, 4, 420, 570);
                    ataqueSprite = new Sprite("Arquivos\\Imagens\\Telas\\ataques.png", 4, 32, 32, 6, 2, 535, 600);
                } catch (IOException e) {
                    Mensagens.messagemErro("Erro ao exibir as Sprites de Katara.\n" + e);
                }
            } else if (nomePersonagem.equals(Util.SOKKA)) {
                try {
                    personagem = new Sprite("Arquivos\\Imagens\\Telas\\SokkaLuta.png", 10, 123, 123, 8, 4, 420, 570);
                    ataqueSprite = new Sprite("Arquivos\\Imagens\\Telas\\ataques.png", 1, 32, 32, 6, 2, 535, 600);
                } catch (IOException e) {
                    Mensagens.messagemErro("Erro ao exibir as Sprites de Sokka.\n" + e);
                }
            } else if (nomePersonagem.equals(Util.TOPH)) {
                try {
                    personagem = new Sprite("Arquivos\\Imagens\\Telas\\TophLuta.png", 10, 136, 123, 8, 4, 420, 570);
                    ataqueSprite = new Sprite("Arquivos\\Imagens\\Telas\\ataques.png", 5, 32, 32, 6, 2, 535, 600);
                } catch (IOException ex) {
                    Mensagens.messagemErro("Erro ao exibir as Sprites de Toph.\n" + ex);
                }
            } else if (nomePersonagem.equals(Util.ZUCO)) {
                try {
                    personagem = new Sprite("Arquivos\\Imagens\\Telas\\ZucoLuta.png", 10, 132, 115, 8, 4, 420, 570);
                    ataqueSprite = new Sprite("Arquivos\\Imagens\\Telas\\ataques.png", 7, 32, 32, 6, 2, 535, 600);
                } catch (IOException e) {
            ...
            if (nomePersonagem.equals(Util.AANG)) {
                try {
                    personagem = new Sprite("Arquivos\\Imagens\\Telas\\AangLuta.png", 28, 172, 112, 8, 4, 800, 570);
                    ataqueSprite = new Sprite("Arquivos\\Imagens\\Telas\\ataques.png", 18, 32, 32, 10, 2, 770, 600);
                } catch (IOException e) {
                    Mensagens.messagemErro("Erro ao exibir as Sprites de Aang.\n" + e);
                }
            } else if (nomePersonagem.equals(Util.KATARA)) {
                try {
                    personagem = new Sprite("Arquivos\\Imagens\\Telas\\KataraLuta.png", 28, 135, 122, 8, 4, 800, 570);
                    ataqueSprite = new Sprite("Arquivos\\Imagens\\Telas\\ataques.png", 14, 32, 32, 10, 2, 770, 600);
                } catch (IOException e) {
                    Mensagens.messagemErro("Erro ao exibir as Sprites de Aang.\n" + e);
                }
            } else if (nomePersonagem.equals(Util.SOKKA)) {
                try {
                    personagem = new Sprite("Arquivos\\Imagens\\Telas\\SokkaLuta.png", 28, 123, 123, 8, 4, 800, 570);
                    ataqueSprite = new Sprite("Arquivos\\Imagens\\Telas\\ataques.png", 19, 32, 32, 10, 2, 770, 600);
                } catch (IOException e) {
                    Mensagens.messagemErro("Erro ao exibir as Sprites de Aang.\n" + e);
                }
            } else if (nomePersonagem.equals(Util.TOPH)) {
                try {
                    personagem = new Sprite("Arquivos\\Imagens\\Telas\\TophLuta.png", 28, 136, 123, 8, 4, 780, 570);
                    ataqueSprite = new Sprite("Arquivos\\Imagens\\Telas\\ataques.png", 15, 32, 32, 10, 2, 770, 600);
                } catch (IOException e) {
                    Mensagens.messagemErro("Erro ao exibir as Sprites de Aang.\n" + e);
                }
            } else if (nomePersonagem.equals(Util.ZUCO)) {
                try {
                    personagem = new Sprite("Arquivos\\Imagens\\Telas\\ZucoLuta.png", 28, 132, 115, 8, 4, 800, 570);
                    ataqueSprite = new Sprite("Arquivos\\Imagens\\Telas\\ataques.png", 13, 32, 32, 10, 2, 770, 600);
                } catch (IOException e) {
                    Mensagens.messagemErro("Erro ao exibir as Sprites de Aang.\n" + e);
                }
            }
    ...
    public void inicializarElementoAtaque() {
        if (orientacao.equals(Util.ESQUERDA)) {
            ataqueSprite.posX = 535;
            Util.flagAtacandoPoder1 = false;
        }else{
            ataqueSprite.posX = 770;
